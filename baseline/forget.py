...
def main(cfg):
    ...
    if cfg.split in ['forget01','forget05','forget10', "forget05_seq2", "forget05_seq3", "forget05_seq4", "forget05_seq5", "forget05_seq6"]:
    ...
    training_args = transformers.TrainingArguments(
            ...
            bf16=True,
            bf16_full_eval=True,
            logging_steps=1, # do not save the model
            logging_dir=f'{cfg.save_dir}/logs',
            output_dir=cfg.save_dir,
            optim="paged_adamw_32bit",
            # save_steps=1, # do not save the model
    ...
    # total_params = sum(p.numel() for p in model.parameters())
    # temp = [p.numel() for p in model.parameters()]
    # print(total_params)
    # print(total_params)
    # print(total_params)
    # print(total_params)
